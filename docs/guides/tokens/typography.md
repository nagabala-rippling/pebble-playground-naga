...
**V2 Token Structure:** `typestyleV2{Category}{Size}` (append `Emphasized` for bolder weight)
...
const MyComponent = () => {
  ...
  return <div style={theme.typestyleV2BodyMedium}>Body text content</div>;
};
```
...
| Use Case       | Token                      |
| -------------- | -------------------------- |
| Hero heading   | `typestyleV2DisplayLarge`  |
| Page title     | `typestyleV2DisplayMedium` |
| Section header | `typestyleV2TitleLarge`    |
| Card title     | `typestyleV2TitleMedium`   |
| Body text      | `typestyleV2BodyMedium`    |
| Small text     | `typestyleV2BodySmall`     |
| Button label   | `typestyleV2LabelLarge`    |
| Form label     | `typestyleV2LabelMedium`   |
